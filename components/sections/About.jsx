...
const phases = [
  {
    ...
    body: "I'm Zainab Aamir — a Full Stack Developer, Sindh. My work lives at the intersection of code and climate, where technology becomes a tool for real-world impact.",
  ...
  },
  {
    ...
    body: 'Full Stack Developer building web apps with HTML, CSS, JavaScript, & Python. Active on GitHub with 38+ repos. Exploring AI, ML and automation tools like n8n and LangChain.',
  ...
  },
  {
    ...
    body: 'Building — engineering dynamic full-stack web projects from scratch. Constantly experimenting with new web technologies, responsive design, and performance-driven digital tools.',
        ...
        <div className="about-grid" style={{
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', gap: '6px', flexWrap: 'wrap', marginTop: '32px' }}>
              {['Web Dev', 'Full Stack Developer'].map((tag, i) => (
                <span key={tag} style={{
